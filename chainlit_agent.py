...
""",
    ...
    llm = ChatOpenAI(model="gpt-4o-mini", temperature=0, streaming=True, callbacks=[cl.LangchainCallbackHandler()])
    ...
    await cl.Message(content="Hello! I'm ready to assist you. Please ask your question.").send()
...
async def on_message(message: cl.Message):
    ...
    await cl.Message(content=assistant_reply, author="Assistant").send()
